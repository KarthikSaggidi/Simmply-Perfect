                  ...
                  <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                    <div className="grid md:grid-cols-2 gap-5">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50/50 border border-slate-200 rounded-xl px-4 py-3.5 text-sm outline-none transition-all focus:border-[#0A2E6F] focus:bg-white"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                      <div className="space-y-2">
                        ...
                        <input
                          type="tel"
                          placeholder="Phone Vector Number"
                          required
                          value={form.phone}
                      ...
                      <div className="space-y-2">
                        ...
                        <select
                          ...
                          className="w-full bg-slate-50/50 border border-slate-200 rounded-xl px-4 py-3.5 text-sm outline-none transition-all focus:border-[#0A2E6F] focus:bg-white appearance-none cursor-pointer"
                        >
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        className="w-full bg-slate-50/50 border border-slate-200 rounded-xl px-4 py-3.5 text-sm outline-none resize-none transition-all focus:border-[#0A2E6F] focus:bg-white"
                      />
                    </div>
